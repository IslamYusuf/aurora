...
const Order = () => {
    ...
    const { id } = useParams();
    const {
        order, loading, error, paymentUpdateError
    } = useSelector(state => state.orderDetails);
    const {
        success: successPay, error: errorPay, loading: loadingPay,
        message: messagePay, pending: pendingPay,
    ...
    const confirmMpesaPaymentHandler = () => {
        //dispatch an action to get the details of the order
